...
// src/main.ts
var DEFAULT_FILE_PATH = "random.json";
var MESSAGE = "message";
function rand(arr) {
  return arr[Math.floor(Math.random() * arr.length)];
}
async function getData(filePath = DEFAULT_FILE_PATH, ref, octokit) {
...
async function run() {
  try {
    ...
    const JSON_FILE_PATH = getInput("JSON_FILE_PATH") || process.env.JSON_FILE_PATH;
